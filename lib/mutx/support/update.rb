...
module Mutx
  module Support
    class Update
      ...
      def self.mutx_conf
        update_json_file "conf/mutx.conf"
      end

      # Returns the updated version of a json file, and writes it in the disk
      #
      # It updates a file located in mutx folder inside the project, with all new keys and sub-keys in of it's template file
